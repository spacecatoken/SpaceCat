 ...
 */
contract SpaceCat is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private constant _tTOTAL = 900 * 1e6 * 10**_DECIMALS;
    ...
    address public developmentWallet = 0x4B8a0eb5A5A2cA757e037a6C03f297A35F5787eF;
     ...
     * Whale actions.
     */       
    uint256 public _maxTxAmount = 4e6 * 10**_DECIMALS;
    
    /**
     * @dev The number of tokens sell, to add to the liquidity.
     */     
    uint256 public numTokensSellToAddToLiquidity = 4e5 * 10**_DECIMALS;
     ...
     * Requirements:
     *
     * The new amount must be less than or equal to four million.
     */   
    function setNumTokensSellToAddToLiquidity(uint256 newAmount) external onlyOwner() {
        require(newAmount <= 4e6 * 10**_DECIMALS, 
            "BEP20: the amount must be lesser than or equal to four million."
        );      
     ...
     * Requirements:
     *
     * The new amount must be greater than or equal to four million to avoid misuse 
     * of the function.
     */      
    function setMaxTxAmount(uint256 newAmount) external onlyOwner() {
        require(newAmount >= 4e6 * 10**_DECIMALS, 
            "BEP20: the amount must be greater than or equal to four million."
        );        
